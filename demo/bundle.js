...
/***/ function(module, exports, __webpack_require__) {
	...
	var SvgCamera = __webpack_require__(168);
	...
	function render() {
	  var ui = React.createElement(
	    ...
	    React.createElement(
	      SvgCamera,
	      { camera: camera },
	      React.createElement('circle', { cx: '200', cy: '200', r: '20', fill: 'red' }),
	      React.createElement('circle', { cx: '250', cy: '200', r: '20', fill: 'green' }),
	      React.createElement('circle', { cx: '300', cy: '200', r: '20', fill: 'blue' })
	    )
	  );
	...
	/***/function (module, exports, __webpack_require__) {
		...
		var SvgCamera = React.createClass({
			...
			render: function render() {
				...
				return React.createElement('svg', _extends({}, this.props, { viewBox: viewbox, style: style, ref: this.cacheSize }), this.props.children);
			},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  var ReactInvalidSetStateWarningDevTool = __webpack_require__(190);
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(191);
	  var ReactComponentTreeDevtool = __webpack_require__(192);
	  ReactDebugTool.addDevtool(ReactInvalidSetStateWarningDevTool);
	  ReactDebugTool.addDevtool(ReactComponentTreeDevtool);
	  ReactDebugTool.addDevtool(ReactNativeOperationHistoryDevtool);
	  var url = ExecutionEnvironment.canUseDOM && window.location.href || '';
